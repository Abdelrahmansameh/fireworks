...
export const SKILL_TREE_CONFIG = {
    ...
    nodes: {
        ...
        launcher_sparkle_1: {
            ...
            desc: '×1.5 sparkles per launcher firework (per level)',
            baseCost: 2500,
            costRatio: 3.5,
            currency: 'sparkles',
            maxLevel: 5,
            requires: { upgrades: { launcher_spawn_rate: 1 } },
            apply: (game, level) => { game.launcherStats.sparkleYieldMultiplier = Math.pow(1.5, level); },
        },
        launcher_sparkle_2: {
            offset: { x: -200, y: 0 },
            icon: 'launcher',
            ...
            group: 'LAUNCHER',
            name: 'Dense Packing',
            desc: '×1.3 sparkles per launcher firework',
            baseCost: 30000,
            costRatio: 6.0,
            currency: 'sparkles',
            maxLevel: 3,
            requires: { upgrades: { launcher_sparkle_1: 5 } },
            apply: (game, level) => { game.launcherStats.sparkleYieldMultiplier *= 1.3; },
        },
        ...
        generator_production: {
            ...
            desc: '×2.5 generator production rate',
            baseCost: 2000,
            costRatio: 1.6,
            currency: 'gold',
            maxLevel: 5,
            requires: { upgrades: { resource_generator: 1 } },
            apply: (game, level) => { game.generatorStats.productionRateMultiplier = Math.pow(2.5, level); },
        },
        generator_overclock: {
            offset: { x: -200, y: 0 },
            icon: 'base',
        ...
        catapult_spawn_rate: {
            ...
            desc: '×0.9 catapult fire interval',
            baseCost: 200,
            costRatio: 1.5,
            currency: 'gold',
            maxLevel: 5,
