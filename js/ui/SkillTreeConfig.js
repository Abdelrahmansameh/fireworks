...
export const SKILL_TREE_CONFIG = {
    ...
    nodes: {
        ...
        spark_core_2: {
            ...
            group: 'BASE',
            name: 'Spark Core II',
            desc: 'x5 sparkles per firework',
            baseCost: 10000,
            costRatio: 6.0,
            currency: 'sparkles',
            maxLevel: 3,
            requires: { upgrades: { base_mult_1: 3 } },
            apply: (game, level) => { game.baseSparkleMultiplier *= 5; },
        },
        spark_core_3: {
            offset: { x: 0, y: -200 },
            icon: 'base',
            ...
            group: 'BASE',
            name: 'Spark Core III',
            desc: 'x10 sparkles per firework',
            baseCost: 50000,
            costRatio: 2.2,
            currency: 'gold',
            maxLevel: 3,
        ...
        launcher_overclock: {
            ...
            desc: '×0.75 launcher spawn interval',
            baseCost: 8000,
            costRatio: 5.0,
            currency: 'sparkles',
            maxLevel: 3,
            requires: { upgrades: { launcher_spawn_rate: 5 } },
            apply: (game, level) => { game.launcherStats.spawnIntervalMultiplier *= Math.pow(0.75, level); },
        },
        launcher_sparkle_1: {
            offset: { x: -200, y: 0 },
            icon: 'launcher',
            ...
            apply: (game, level) => { game.launcherStats.sparkleYieldMultiplier += 2 * level; },
        },
        launcher_sparkle_2: {
            offset: { x: -200, y: 0 },
            icon: 'launcher',
        ...
        generator_production: {
            ...
            apply: (game, level) => { game.generatorStats.productionRateMultiplier = Math.pow(2.0, level); },
        },
        generator_overclock: {
            offset: { x: -200, y: 0 },
            icon: 'base',
            ...
            desc: '×3 generator production rate',
            baseCost: 30000,
            costRatio: 2.0,
            currency: 'gold',
            maxLevel: 3,
            requires: { upgrades: { generator_production: 5 } },
            apply: (game, level) => { game.generatorStats.productionRateMultiplier *= Math.pow(3, level); },
        },
        ...
        drone_sparkle_yield: {
            ...
            group: 'DRONE',
            name: 'Energy Siphon',
            desc: '×2.0 sparkles per collected particle',
            baseCost: 600,
            costRatio: 1.7,
            currency: 'gold',
            maxLevel: 5,
            requires: { upgrades: { drone_hub: 1 } },
            apply: (game, level) => { game.droneStats.sparklesPerParticleMultiplier = 1 + 1.0 * level; },
        },
        ...
        crowd_catcher_yield: {
            ...
            group: 'CROWD',
            name: 'Greedy Hands',
            desc: '×2.0 sparkles per caught particle',
            baseCost: 500,
            costRatio: 2.5,
            currency: 'gold',
            maxLevel: 5,
            requires: { upgrades: { crowd_catcher_unlock: 1 } },
            apply: (game, level) => { game.crowdStats.sparklesPerParticleMultiplier = 1 + 1.0 * level; },
        },
